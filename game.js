...
(() => {
  ...
  function render() {
    ...
    ctx.fillStyle='#2f8f46'; ctx.fillRect(0,0,W,H);
    const shade=ctx.createLinearGradient(0,0,W,H); shade.addColorStop(0,'#69b85d40'); shade.addColorStop(1,'#155a2a80'); ctx.fillStyle=shade;ctx.fillRect(0,0,W,H);
